defmodule Podium do
  ...
  def update_conversation_item(%ConversationItem{uid: uid} = item, opts \\ []) do
    {headers, opts} = Keyword.pop(opts, :headers, [])
    ...
    API.put("/conversation_items/#{uid}", body, headers, opts)
  end

  @doc """
  Delete a conversation item.
  """
  @spec delete_conversation_item(String.t(), Keyword.t()) :: :ok
  def delete_conversation_item(uid, opts \\ []) do
    {headers, opts} = Keyword.pop(opts, :headers, [])

    API.delete("/conversation_items/#{uid}", headers, opts)
  end
